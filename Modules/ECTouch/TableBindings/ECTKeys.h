...
extern NSString *const ECTBackKey;
extern NSString *const ECTClassKey;
extern NSString *const ECTDisclosureKey;
extern NSString *const ECTFontKey;
extern NSString *const ECTTitleKey;
extern NSString *const ECTEnabledKey;
extern NSString *const ECTImageKey;
extern NSString *const ECTLabelKey;
extern NSString *const ECTNameKey;
extern NSString *const ECTPlaceholderKey;
extern NSString* const ECTSectionsKey;
extern NSString* const ECTSizeKey;
