...
NSString *const ECTDisclosureKey = @"disclosure";
NSString *const ECTFontKey = @"font";
NSString *const ECTBackKey = @"back";
NSString *const ECTClassKey = @"class";
NSString *const ECTTitleKey = @"title";
NSString *const ECTEnabledKey = @"enabled";
NSString *const ECTImageKey = @"image";
NSString *const ECTLabelKey = @"label";
NSString *const ECTNameKey = @"name";
NSString *const ECTPlaceholderKey = @"placeholder";
NSString* const ECTSectionsKey = @"sections";
NSString *const ECTSizeKey = @"size";
